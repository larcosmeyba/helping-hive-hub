...
export function CookFromFridge() {
  ...
  return (
    <div className="bg-gradient-to-br from-card to-secondary/30 rounded-2xl border border-border p-6 shadow-card">
      <div className="flex items-start gap-3 mb-4">
        <div className="bg-primary/10 rounded-xl p-2.5">
          <Refrigerator className="w-6 h-6 text-primary" />
        </div>
        <div>
          <h2 className="font-display text-lg font-semibold text-foreground">Cook From Your Fridge</h2>
          <p className="text-sm text-muted-foreground">Select ingredients you have — we'll find recipes that match.</p>
        </div>
      </div>
