...
export function CookFromFridge() {
  ...
  return (
    <div className="bg-gradient-to-br from-card to-secondary/30 rounded-2xl border border-border p-4 md:p-6 shadow-card w-full">
      <div className="flex items-center gap-2 mb-3 md:mb-4">
        ...
        <div>
          ...
          <p className="text-xs md:text-sm text-muted-foreground">Select ingredients — we'll find recipes.</p>
        </div>
      </div>
      ...
      <div className="flex gap-2 mb-3 md:mb-4">
        <Input
          ...
          className="text-sm h-10 md:h-10 rounded-xl"
        />
        <Button size="sm" variant="outline" onClick={addCustom} className="shrink-0 h-10 w-10 rounded-xl p-0">
      ...
      <div className="flex items-center gap-2">
        <Link
          to="/dashboard/pantry"
          className="text-xs md:text-sm text-muted-foreground hover:text-primary underline whitespace-nowrap"
        >
          Manage Pantry →
        </Link>
        <Button
          ...
          className="bg-gradient-honey text-primary-foreground hover:opacity-90 ml-auto h-11 text-sm px-4 md:h-10 md:text-sm md:px-4 rounded-xl font-semibold shadow-soft whitespace-nowrap"
          size="sm"
        >
