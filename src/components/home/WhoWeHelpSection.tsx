...
import { Users, Landmark, GraduationCap, Shield, BookOpen, Wallet } from "lucide-react";
...
const audiences = [
  ...
  { icon: Shield, title: "Government Workers", desc: "Simplified meal planning for public servants." },
