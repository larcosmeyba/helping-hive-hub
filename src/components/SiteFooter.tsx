    ...
    <footer style={{ backgroundColor: "#15181D" }} className="text-white">
      ...
      <div className="container mx-auto px-4 py-8">
        <p className="text-center text-[11px] text-white/40 leading-relaxed max-w-3xl mx-auto mb-4">
          Help The Hive is an independent grocery budgeting service integrated with the Instacart Developer Platform for grocery fulfillment. INSTACART<sup>®</sup> is a trademark of Maplebear Inc. d/b/a Instacart. Instacart may not be available in all ZIP or postal codes. Service fees apply.
        </p>
