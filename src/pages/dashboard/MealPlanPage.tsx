...
export default function MealPlanPage() {
  ...
  return (
    <div className="max-w-6xl mx-auto space-y-5 md:space-y-6">
      ...
      {/* Regenerate button — full width, large tap target */}
      <Button
        onClick={generate}
        disabled={generating}
        variant="outline"
            ...
            {day.meals.map((originalMeal, mealIndex) => {
              ...
              return (
                <div key={`${day.day}-${mealIndex}`} className="snap-start shrink-0 w-[140px] md:w-auto md:shrink">
                  <div className="bg-card rounded-2xl border border-border shadow-card overflow-hidden w-[140px] h-[120px] md:w-auto md:h-auto">
